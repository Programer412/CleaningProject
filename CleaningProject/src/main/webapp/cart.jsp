...
int total=0;
	List<details> d=us.home(r.getEmail());
	for(details o:d)
	{ 
...
<a href="delete?id=<%=o.getId()%>&&userid=<%=o.getUserid()%>"><button class="btn2">delete</button></a>
</td>
				<td style="width:100px; height:200px;">
<a href="checkout?id=<%=o.getId()%>&&userid=<%=o.getUserid()%>"><button class="btn2">Checkout</button></a>
</td>
...
<td>All Category</td>
<td> <%=total %>$</td>
<td><a href="delete?id=0&&userid=0"><button class="btn2">Delete All</button></a></td>
<td><button class="btn2">Checkout All</button></td>
